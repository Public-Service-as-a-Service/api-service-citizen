...
public class CitizenResource {
	...
	public ResponseEntity<CitizenExtended> getCitizenById(
		@Parameter(description = "ID for specific citizen") @ValidUuid @PathVariable final String personId,
		@Parameter(description = "If true, include search for classified persons") @RequestParam(defaultValue = "false") final boolean showClassified) {
	...
	public ResponseEntity<List<CitizenWithChangedAddress>> getCitizensWithChangedAddress(
		@Parameter(description = "From-date for move") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) final OffsetDateTime changedDateFrom) {
	...
	public ResponseEntity<String> getPersonalNumberById(
		@Parameter(description = "personID, Guid, for specific citizen") @ValidUuid @PathVariable final String personId) {
